<footer class="site-footer">
    <div class="footer-top">
        ...
        <div class="footer-brand">
            <div class="footer-logo">
                ...
                <span class="footer-logo-text">Best Doctors<br>Insurance</span>
            </div>
            <p>At Best Doctors Insurance, we are proud to help our members enjoy better and healthier lives.</p>
        </div>
        ...
        <div class="footer-column">
            ...
            <ul>
                ...
                <li><a href="#">Why Best Doctors Insurance</a></li>
    ...
    <div class="footer-bottom">
        <p>&copy; 2026 Best Doctors Insurance. All rights reserved.</p>
